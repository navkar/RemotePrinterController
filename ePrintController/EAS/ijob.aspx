...
<html>
	...
	<PagerStyle Mode="NextPrev" HorizontalAlign="Left"
   	...
   	<Columns>
		...
		<asp:BoundColumn HeaderText="File Name" DataField="job_filename"/> 
...
<script language="C#" runat="server">
		...
		void CancelPrintCommand(Object sender, DataGridCommandEventArgs e) 
		{
				...
				if (htConfig != null)
				{
					string strDBUrl = (string) htConfig["database_url"];
					string strSQL 
					= "update jobinfo set job_status = '5' where job_id = '" +
					  jobIdCell.Text +"' and job_status = '2'";
 		...
 		public void Page_Load( Object source, EventArgs e)
		{
		    ...
		    if (!Page.IsPostBack && strPrinterGuid != null )
		    {
				...
				if (htConfig != null)
				{
					...
					string strDbURL = (string) htConfig["database_url"];
					string strJobQueueName = (string) htConfig["job_queue_name"];
				    ...
				    string strSQL = "select area_code, printer_id, ept_host_ip, ept_host_portno from printer where printer_guid='" + strPrinterGuid + "'";
